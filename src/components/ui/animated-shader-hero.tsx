...
export const ShaderBackground: React.FC<ShaderBackgroundProps> = ({ children, className = '' }) => {
...
void main(){gl_Position=position;}`;
  ...
  return (
    <div className={`overflow-hidden ${className}`} style={{ position: 'absolute', inset: 0 }}>
      <canvas
        ref={canvasRef}
